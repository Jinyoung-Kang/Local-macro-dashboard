...
CFTC COT(Commitments of Traders) 6개 자산의 3년 시계열.

[주 1회 공시이고 시차가 있습니다]
기준일은 매주 화요일, 공시는 금요일입니다. 화면에 뜨는 포지션은
**최소 3일, 보통 일주일 전**의 것입니다. 스냅샷이 "수집 시점 대비 N일
전"을 함께 적는 이유이며, 일중 시세와 같은 시점으로 놓고 비교하면
안 됩니다.

순포지션의 부호만 보지 말고 **백분위**를 함께 보세요. -76,000계약이
과매도인지 평범한지는 그 자산의 역사적 분포가 정합니다.
"""
import logging
import time
